<template>
  <div>
    ...
    <div class="buttons_container">
      <button
        @click="handleFilterAgeActive"
        :class="{ active: filterAgeActive }"
      >
        {{ filterAgeActive ? "Unfilter" : "Filter" }} age >30
      </button>
      <button
        @click="handleFilterAgeAndMedicineActive"
        :class="{ active: filterAgeAndMedicineActive }"
      >
        {{ filterAgeAndMedicineActive ? "Unfilter" : "Filter" }} age &lt; 63 and
        medicines strength > 8
      </button>
    </div>
